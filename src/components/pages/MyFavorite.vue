<template>
  <div id="MyFavorite">
    <!-- <h2 class="pageTitle">我的收藏</h2> -->
    <div class="tabs">
      <a href="#store" data-uk-smooth-scroll="{offset: 80}"><mu-raised-button mini primary>店家</mu-raised-button></a>
      <a href="#designer" data-uk-smooth-scroll="{offset: 80}"><mu-raised-button mini secondary>設計師</mu-raised-button></a>
      <a href="#work" data-uk-smooth-scroll="{offset: 80}"><mu-raised-button mini secondary>作品</mu-raised-button></a>
    </div>
    <div id="store" class="sec">
      <div class="container">
        <h3>我收集的髮廊</h3>
            ...
            <md-card>
              <md-card-area>
                ...
                <md-card-header>
                  ...
                  <div class="md-subhead">台中市西區</div>
                </md-card-header>
              ...
              <md-card-actions>
                ...
                <md-button class="md-icon-button">
                  ...
                  <md-tooltip md-direction="top">設計師</md-tooltip>
                </md-button>

                <md-button class="md-icon-button" @click="$router.push({name: 'StoreView', hash: '#service'})">
          ...
          <div v-for="n in 10" class="card-wrap">
            <md-card>
              <md-card-area>
                ...
                <md-card-header>
                  <div class="md-title">CUTE SALON</div>
                  <div class="md-subhead">女, 中長髮</div>
                </md-card-header>
              </md-card-area>
