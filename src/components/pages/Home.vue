  ...
  <div id="Home">
    ...
    <div class="row searchBox">
      <div class="col-xs-12 col-sm-8 col-md-6">
        <mu-select-field :labelFocusClass="['label-foucs']" hintText="城市">
          <mu-menu-item v-for="city in cityList" :value="city" :title="city" />
        </mu-select-field>
        <mu-select-field :labelFocusClass="['label-foucs']" hintText="地區">
          <mu-menu-item v-for="area in areaList" :value="area" :title="area" />
        </mu-select-field>
        <mu-raised-button primary>搜尋</mu-raised-button>
      </div>
    </div>
